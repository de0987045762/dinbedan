...
3. 在 Firebase Console 建立 Email/Password 帳號並啟用 Email/Password 登入方式。
   ...
   登入畫面提供「記住 Email」勾選與示範帳號快速填入按鈕，可協助測試與展示。
...
- **公告管理 (管理員專用)**：新增、編輯、刪除公告並即時監聽 Firestore 顯示最新內容。
- **據點管理 (管理員專用)**：建立與編輯營運據點，變更立即同步至戰報與菜單表單。
- **戰報**：所有登入者皆可新增與編輯自己的戰報。管理員可維護所有紀錄，員工僅能維護並刪除自己提交的資料。
- **菜單管理**：員工可新增、編輯每日菜單與備註；管理員或本人可維護並刪除紀錄。
- **排班管理**：員工可新增、編輯班表資訊，支援即時監聽與本人刪除，管理員可調整所有班表。
- **許願池**：員工可提交與編輯願望，管理員或本人可刪除紀錄。
- **點數商城申請**：員工可提出與修改兌換申請，管理員或本人可刪除紀錄。
